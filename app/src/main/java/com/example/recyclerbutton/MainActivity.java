...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setHasFixedSize(true);
                ...
                list.add(new MyMovieData("Avengers","2019 film",R.drawable.avenger,"#FF80AB"));
                list.add(new MyMovieData("Venom","2018 film",R.drawable.venom,"#FFD180"));
                list.add( new MyMovieData("Batman Begins","2005 film",R.drawable.batman,"#FF6200EE"));
                list.add(new MyMovieData("Jumanji","2019 film",R.drawable.jumanji,"#FFBB86FC"));
                list.add (new MyMovieData("Good Deeds","2012 film",R.drawable.good_deeds,"#FF03DAC5"));
                    ...
                    public void onClick(View view) {
                        ...
                        buttonAdd.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                list.add(new MyMovieData(name,number,R.drawable.avatar,"#FF80AB"));
