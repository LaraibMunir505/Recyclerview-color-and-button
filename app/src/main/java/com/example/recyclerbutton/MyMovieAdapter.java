...
public class MyMovieAdapter extends RecyclerView.Adapter<MyMovieAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.linearLayout.setBackgroundColor(Color.parseColor(myMovieDatalist.getColors()));
            ...
            public void onClick(View view) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        list.set(position,new MyMovieData(name,number,R.drawable.batman,"#FF6200EE"));
